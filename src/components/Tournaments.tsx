    ...
    <div className="min-h-screen bg-gradient-to-b from-[#0a0e1a] via-[#0f1419] to-[#0a0e1a] relative">
      ...
      <div className="relative z-10">
          ...
          <div className="relative max-w-7xl mx-auto px-6 pt-40 pb-16">
            <div className="flex items-center justify-between mb-8">
              <div>
                <div className="flex items-center gap-2 mb-4">
                  <img src={teemoTournamentsIcon} alt="Tournaments" className="w-44 h-44 object-contain -my-12 -mr-8" />
                  <h1 className="text-5xl text-white font-bold">Tournaments</h1>
                </div>
                <p className="text-white/60 text-lg">Compete for glory and real cash prizes in League of Legends tournaments</p>
              </div>
              
              <button
                onClick={onCreateTournament}
                className="flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-[#00d4ff] to-[#00a3cc] text-white rounded-xl hover:shadow-lg hover:shadow-[#00d4ff]/30 transition-all duration-300 group"
              >
            ...
            <div className="grid grid-cols-4 gap-4 mb-8">
              <div className="bg-gradient-to-br from-[#1a1d29] to-[#151821] rounded-xl p-4 border border-white/5">
                ...
                <p className="text-3xl font-bold text-white">{tournaments.filter(t => t.status === 'ongoing' || t.status === 'registration').length}</p>
              </div>
              ...
              <div className="bg-gradient-to-br from-[#1a1d29] to-[#151821] rounded-xl p-4 border border-white/5">
                ...
                <p className="text-3xl font-bold text-white">€{tournaments.reduce((sum, t) => sum + t.prize, 0).toLocaleString()}</p>
              </div>
              ...
              <div className="bg-gradient-to-br from-[#1a1d29] to-[#151821] rounded-xl p-4 border border-white/5">
                ...
                <p className="text-3xl font-bold text-white">{tournaments.reduce((sum, t) => sum + t.registeredTeams, 0)}</p>
              </div>
              ...
              <div className="bg-gradient-to-br from-[#1a1d29] to-[#151821] rounded-xl p-4 border border-white/5">
                ...
                <p className="text-3xl font-bold text-white">{tournaments.filter(t => t.status === 'completed').length}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 py-6">
          <div className="bg-gradient-to-br from-[#1a1d29] to-[#151821] rounded-xl p-6 border border-white/5 mb-6">
            <div className="flex items-center gap-4 flex-wrap">
              {/* Tabs */}
              <div className="flex items-center gap-2 bg-[#0a0e1a]/50 rounded-lg p-1">
              ...
              <div className="flex items-center gap-2">
                ...
                <select
                  ...
                  className="bg-[#0a0e1a]/50 border border-white/10 rounded-lg px-4 py-2 text-white text-sm focus:outline-none focus:border-[#00d4ff]/50"
                >
              ...
              >
                ...
                <div className="relative h-40 overflow-hidden">
                  ...
                  <div className="absolute top-4 right-4">
                    <span className={`px-3 py-1 rounded-lg text-xs font-medium border ${getStatusColor(tournament.status)}`}>
                  ...
                  <div className="absolute bottom-4 left-4">
                    <div className="flex items-center gap-2 bg-gradient-to-r from-yellow-400 to-orange-500 px-4 py-2 rounded-lg shadow-lg shadow-yellow-500/20">
                      <Trophy className="w-5 h-5 text-white" />
                      <span className="text-white font-bold text-lg">€{tournament.prize.toLocaleString()}</span>
                    </div>
                  </div>
                </div>
                ...
                {/* Content */}
                <div className="p-6">
                  <h3 className="text-white text-xl font-bold mb-3 group-hover:text-[#00d4ff] transition-colors">
                    {tournament.name}
                  </h3>
                  ...
                  {/* Action Button */}
                  <button className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-gradient-to-r from-[#00d4ff]/10 to-[#00a3cc]/10 border border-[#00d4ff]/20 text-[#00d4ff] rounded-lg hover:border-[#00d4ff]/50 hover:shadow-lg hover:shadow-[#00d4ff]/20 transition-all duration-300 group">
