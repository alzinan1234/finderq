  ...
  return (
    ...
    >
          ...
          >
            ...
            <div className="relative flex items-center -my-4">
              <img
                ...
                alt="FinderQ Logo"
                className="h-44 w-auto object-contain transition-all duration-300 group-hover:scale-105"
              />
            </div>
          ...
          >
            <div className="relative flex items-center gap-0">
              <img
                ...
                alt="Region"
                className="w-20 h-20 object-contain -my-7 -mr-2"
              />
              <span className="text-white font-bold text-lg">{currentRegionLabel}</span>
          ...
          <AnimatePresence>
            {isRegionDropdownOpen && (
              <motion.div
                ...
                className="absolute top-full left-0 mt-2 bg-gradient-to-b from-[#1a1d29]/95 to-[#0a0e27]/95 backdrop-blur-xl rounded-xl shadow-2xl py-3 min-w-[180px] border border-[#00d4ff]/20 overflow-hidden"
              >
      ...
      <div className="flex items-center gap-3">
        ...
        <Link
          href="/tournaments"
          className="flex items-center gap-0 px-3 py-1.5 bg-white/5 backdrop-blur-md rounded-xl hover:bg-white/10 transition-all duration-300 border border-white/10 hover:border-[#00d4ff]/40 cursor-pointer overflow-visible"
        >
          <img
            src="/assets/bad3e7b50eef2663c37644cbb4e2dd7f01819802-3840x2160-removebg-preview.png"
            alt="Tournaments"
            className="w-28 h-28 object-contain -mt-12 -mb-10 -mr-6"
          />
        ...
        <Link
          href="/media"
          className="flex items-center gap-2 px-3 py-1.5 bg-white/5 backdrop-blur-md rounded-xl hover:bg-white/10 transition-all duration-300 border border-white/10 hover:border-[#c89b3c]/40 cursor-pointer overflow-visible"
        >
          <img
            src="/assets/Teemo_cs.png"
            alt="Media"
            className="w-14 h-14 object-contain -my-5"
          />
        ...
        <Link
          href="/challenges"
          className="flex items-center gap-2 px-3 py-1.5 bg-white/5 backdrop-blur-md rounded-xl hover:bg-white/10 transition-all duration-300 border border-white/10 hover:border-yellow-500/40 cursor-pointer"
        >
        ...
        {isLoggedIn && (
          <button
            ...
            className="relative w-10 h-10 rounded-xl bg-white/5 backdrop-blur-md hover:bg-white/10 border border-white/10 hover:border-[#c89b3c]/40 flex items-center justify-center transition-all duration-300"
          >
        ...
        {!isLoggedIn && (
          <button
            className="flex items-center gap-0 px-3 py-1.5 bg-white/5 backdrop-blur-md rounded-xl hover:bg-white/10 transition-all duration-300 border border-white/10 hover:border-[#00d4ff]/40 text-white font-semibold text-sm overflow-visible"
          ...
          >
            <img
              ...
              alt="Sign Up"
              className="w-[5.625rem] h-[5.625rem] object-contain -my-9 -mr-5 -ml-5"
            />
            {t('signUp')}
          </button>
        )}
        ...
        <div className="relative">
          <button
            ...
            className="w-10 h-10 rounded-xl bg-white/5 backdrop-blur-md hover:bg-white/10 transition-all duration-300 flex items-center justify-center overflow-hidden border border-white/10 hover:border-[#00d4ff]/40"
          >
            {isLoggedIn && userName
              ? userAvatar
          ...
          <AnimatePresence>
            {isLoggedIn && isProfileDropdownOpen && (
              <motion.div
                ...
                transition={{ duration: 0.15 }}
                className="absolute right-0 top-12 w-64 bg-gradient-to-br from-[#1a1d29] to-[#0a0e27] rounded-xl border border-white/10 shadow-2xl shadow-black/50 overflow-hidden z-50"
              >
                {/* Header */}
