...
export function RegionPage({
  ...
  // Toggle functions for post creation form
  ...
  return (
    <div className="relative min-h-screen pb-20 overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 pt-40 pb-8">
        {/* Header */}
        <div className="mb-8">
          <div className="inline-flex items-center gap-2 mb-4 overflow-visible">
            <img src={teemoRegionIcon} alt="Region" className="w-20 h-20 object-contain -my-8 -mr-3" />
            <h1 className="text-white text-xl font-bold">{region === 'EUW' ? t('postsEUW') : t('postsEUNE')}</h1>
          </div>
          <p className="text-white/60 text-lg ml-2">{t('findPlayers')}</p>
        </div>
          ...
          <div className="bg-gradient-to-br from-[#0a0e27]/40 via-[#1a1d29]/30 to-[#0a0e27]/40 rounded-2xl overflow-hidden border-2 border-[#c89b3c]/40 shadow-2xl shadow-[#00d4ff]/20 hover:shadow-[#00d4ff]/40 transition-all duration-500">
            {!showPostForm ? (
              <button
                ...
                className="group relative w-full p-8 text-left transition-all duration-500 overflow-hidden hover:scale-[1.02]"
              >
                ...
                {/* Glow orbs */}
                <div className="absolute top-0 right-0 w-64 h-64 bg-[#00d4ff]/10 rounded-full blur-[100px] animate-pulse" />
                <div className="absolute bottom-0 left-0 w-64 h-64 bg-[#c89b3c]/10 rounded-full blur-[100px] animate-pulse" />
                ...
                <div className="relative flex items-center gap-6">
                  ...
                  <div className="relative">
                    ...
                    <div className="relative w-20 h-20 bg-gradient-to-br from-[#00d4ff] via-[#00b8e6] to-[#c89b3c] rounded-2xl flex items-center justify-center shadow-2xl group-hover:scale-110 group-hover:rotate-6 transition-all duration-500 border-2 border-white/30">
                      <Swords className="w-10 h-10 text-white drop-shadow-2xl" />
                    </div>
                  </div>

                  {/* Text content */}
                  <div className="flex-1">
                    <h3 className="text-white text-3xl font-bold mb-2 group-hover:text-[#00d4ff] transition-colors duration-300 drop-shadow-lg">
                      {t('createPost')}
                    </h3>
                  ...
                  {/* Arrow indicator */}
                  <div className="opacity-70 group-hover:opacity-100 group-hover:translate-x-3 transition-all duration-300">
                    <svg className="w-10 h-10 text-[#00d4ff] drop-shadow-lg" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="p-8">
                ...
                <div className="flex items-center justify-between mb-8">
                  <div className="flex items-center gap-4">
                    <div className="relative">
                      ...
                      <div className="relative w-12 h-12 bg-gradient-to-br from-[#00d4ff] to-[#c89b3c] rounded-xl flex items-center justify-center shadow-xl">
                        <Swords className="w-6 h-6 text-white" />
                      </div>
                    </div>
                    <div>
                      <h3 className="text-white text-2xl font-bold bg-gradient-to-r from-white via-[#00d4ff] to-white bg-clip-text">
                        {t('createPost')}
                      </h3>
                      <p className="text-white/50 text-sm mt-1">{t('findPlayers')}</p>
                    </div>
                  </div>
                  ...
                  <button
                    ...
                    className="group p-2 hover:bg-white/5 rounded-lg transition-all duration-300"
                  >
                    <svg className="w-6 h-6 text-white/40 group-hover:text-white/80 group-hover:rotate-90 transition-all duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                {!hasPremium && postCooldownRemaining > 0 && (
                  <div className="mb-6 bg-gradient-to-r from-orange-500/10 to-red-500/10 border border-orange-500/30 rounded-lg p-3">
                    <div className="flex items-center gap-2">
                      ...
                      <div className="flex-1">
                        <p className="text-orange-400 text-sm font-medium">Post Cooldown Active</p>
                ...
                {hasPremium && (
                  <div className="mb-6 bg-gradient-to-r from-[#c89b3c]/10 to-[#00d4ff]/10 border border-[#c89b3c]/30 rounded-lg p-3">
                    <div className="flex items-center gap-2">
                      <svg className="w-5 h-5 text-[#c89b3c] flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z" />
                      </svg>
                      <div>
                        <p className="text-transparent bg-gradient-to-r from-[#c89b3c] to-[#00d4ff] bg-clip-text text-sm font-bold">Premium Active</p>
                        <p className="text-white/60 text-xs mt-0.5">
                ...
                {/* Description */}
                <div className="mb-8">
                  <label className="block text-white/90 mb-3 flex items-center gap-2 font-medium">
                  ...
                  <div className="relative">
                    <textarea
                      ...
                      className="w-full px-5 py-4 bg-[#1a1d29]/60 border-2 border-[#c89b3c]/20 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#00d4ff] focus:border-[#00d4ff]/50 resize-none text-white placeholder:text-white/30 transition-all duration-300 hover:border-[#c89b3c]/40"
                      rows={5}
                      value={postContent}
                ...
                {riotAccountLinked && userRank && (
                  <div className="mb-8 bg-gradient-to-br from-[#00d4ff]/10 to-[#00b8e6]/5 border border-[#00d4ff]/30 rounded-xl p-4">
                    <div className="flex items-start gap-3">
                      <div className="w-10 h-10 bg-[#00d4ff]/20 rounded-lg flex items-center justify-center flex-shrink-0">
                        <img src={riotVerifiedLogo} alt="Riot Verified" className="w-6 h-6 object-contain" />
                      </div>
                      <div className="flex-1">
                        <h4 className="text-[#00d4ff] text-sm font-bold mb-1 flex items-center gap-2">
                          {t('riotVerified')}
                ...
                <div className="grid grid-cols-1 gap-8 mb-8">
                  {/* Type Selection */}
                  <div>
                    <label className="block text-white/90 mb-4 flex items-center gap-2 font-medium">
                      <Gamepad2 className="w-5 h-5 text-[#c89b3c]" />
                    ...
                    <div className="flex flex-wrap gap-3">
                      {['Ranked Solo/Duo', 'Ranked Flex', 'Normal Draft', 'SwiftPlay', 'Aram', 'Mayhem', 'Clash'].map((type) => {
                        // Get the appropriate logo for each game mode
                        ...
                        return (
                          <button
                            ...
                            className={`group relative px-6 py-3 rounded-xl text-sm font-medium transition-all duration-300 overflow-hidden min-w-[140px] flex items-center gap-2 justify-center ${
                          ...
                          >
                            ...
                            <img src={getGameModeLogo(type)} alt={type} className="w-5 h-5 object-contain relative z-10" />
                ...
                <div className="flex gap-4 justify-end pt-6 border-t border-white/10">
                  <button
                    ...
                    className="px-6 py-2.5 rounded-lg text-white/70 hover:bg-white/10 border border-white/10 transition-all duration-300"
                  >
                    {t('cancel')}
                  </button>
                  <button
                    ...
                    className="relative px-6 py-2.5 rounded-lg bg-gradient-to-r from-[#00d4ff] to-[#00b8e6] text-white hover:from-[#00b8e6] hover:to-[#009ac7] transition-all shadow-lg shadow-[#00d4ff]/50 overflow-hidden group disabled:opacity-50 disabled:cursor-not-allowed"
                  >
