  ...
  return (
    <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center z-[9999] p-4">
      <div className="bg-gradient-to-br from-[#1a1d29] to-[#151821] rounded-2xl w-full max-w-7xl max-h-[95vh] overflow-hidden border border-[#00d4ff]/20 shadow-2xl shadow-[#00d4ff]/10">
        ...
        <div className="relative h-48 overflow-hidden">
          ...
          <div className="absolute bottom-6 left-6 right-6">
            <div className="flex items-end justify-between">
              ...
              <div className="flex items-center gap-2 bg-gradient-to-r from-yellow-400 to-orange-500 px-6 py-3 rounded-xl shadow-lg shadow-yellow-500/30">
        ...
        {/* Tabs */}
        <div className="border-b border-white/5 px-6 bg-[#0a0e1a]/30">
        ...
        <div className="p-6 overflow-y-auto max-h-[calc(95vh-300px)]">
          ...
          {activeTab === 'overview' && (
            <div className="space-y-6">
              ...
              {/* Description */}
              <div className="bg-gradient-to-br from-[#1a1d29] to-[#151821] rounded-xl p-6 border border-white/5">
          ...
          {activeTab === 'bracket' && (
            <div className="space-y-6">
              ...
              <div className="overflow-x-auto bg-[#0a0e1a]/30 rounded-xl p-4">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gradient-to-br from-[#1a1d29] to-[#151821] rounded-xl p-6 border border-white/5">
                ...
                <div className="space-y-3">
                  {teams.slice(0, 5).map((team, index) => {
                    ...
                    return (
                      <div key={team.id} className={`bg-[#0a0e1a]/50 rounded-lg p-4 border flex items-center justify-between ${
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          {!isDisqualified ? (
                            <button
                              ...
                              className="px-4 py-2 bg-red-600/20 hover:bg-red-600/30 text-red-400 rounded-lg transition-colors text-sm border border-red-500/30"
                            >
                              Disqualify
                            </button>
                          ) : (
                            <button
                              ...
                              className="px-4 py-2 bg-yellow-600/20 hover:bg-yellow-600/30 text-yellow-400 rounded-lg transition-colors text-sm border border-yellow-500/30"
                            >
              ...
              <div className="grid grid-cols-2 gap-4">
                <button
                  ...
                  className="px-6 py-4 bg-gradient-to-r from-[#00d4ff] to-[#00a3cc] text-white rounded-xl font-bold hover:shadow-lg hover:shadow-[#00d4ff]/30 transition-all flex items-center justify-center gap-2"
                >
                  <Target className="w-5 h-5" />
                  Generate Bracket
                </button>
                <button className="px-6 py-4 bg-gradient-to-r from-purple-600 to-purple-800 text-white rounded-xl font-bold hover:shadow-lg hover:shadow-purple-600/30 transition-all flex items-center justify-center gap-2">
      ...
      {isRegisterModalOpen && (
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center z-[99999] p-4">
          <div className="bg-gradient-to-br from-[#1a1d29] to-[#151821] rounded-2xl w-full max-w-2xl border border-[#00d4ff]/20 shadow-2xl max-h-[90vh] overflow-y-auto">
            {/* Header */}
            <div className="p-6 border-b border-white/10 sticky top-0 bg-gradient-to-br from-[#1a1d29] to-[#151821] z-10">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                    ...
                    {teamMembers.map((member, index) => {
                      ...
                      return (
                        <div key={index} className="flex items-center gap-3">
                          <div className="w-8 h-8 bg-[#00d4ff]/20 text-[#00d4ff] rounded-full flex items-center justify-center text-sm font-bold flex-shrink-0">
                            {index + 1}
                          </div>
                          <div className="w-20 flex-shrink-0">
                            <span className="text-white/60 text-sm font-medium">{roles[index]}</span>
                          </div>
                          <input
                            type="text"
                            value={member}
                            ...
                            className="flex-1 bg-[#0a0e1a]/50 border border-white/10 rounded-lg px-4 py-2.5 text-white placeholder-white/30 focus:outline-none focus:border-[#00d4ff]/50"
                          />
                        </div>
                      );
                    })}
            ...
            <div className="p-6 border-b border-white/10">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h2 className="text-2xl font-bold text-white">Declare Tournament Winner</h2>
                ...
                <>
                  ...
                  <div className="p-6">
                        ...
                        return (
                          <div
                            ...
                            className={`bg-[#0a0e1a]/50 rounded-lg border transition-all ${
                              isOwner ? 'border-yellow-500/30 bg-gradient-to-r from-yellow-500/5 to-transparent p-3' : 'border-white/5 hover:border-[#00d4ff]/20 p-4'
                            }`}
                          >
                            <div className="flex items-center justify-between">
                              <div className="flex items-center gap-3">
                                ...
                                <div className="flex-1 min-w-0">
                                  <div className="flex items-center">
                                    <p className={`text-white font-medium ${isOwner ? 'text-base' : 'text-lg'}`}>{member.name}</p>
                                    {isOwner && (
                                      <div className="relative group -ml-14">
                                        <img src={ownerCrownIcon} alt="Owner" className="w-28 h-28 object-contain -my-10" />
                    ...
                    <div className="mt-6 grid grid-cols-3 gap-4">
                      <div className="bg-gradient-to-br from-blue-600/10 to-blue-800/10 border border-blue-500/20 rounded-lg p-4 text-center">
                        <p className="text-blue-400 text-2xl font-bold">5</p>
                        <p className="text-white/60 text-sm">Members</p>
                      </div>
                      <div className="bg-gradient-to-br from-purple-600/10 to-purple-800/10 border border-purple-500/20 rounded-lg p-4 text-center">
                        <p className="text-purple-400 text-2xl font-bold">Platinum+</p>
                        <p className="text-white/60 text-sm">Avg Rank</p>
                      </div>
                      <div className="bg-gradient-to-br from-green-600/10 to-green-800/10 border border-green-500/20 rounded-lg p-4 text-center">
                        <p className="text-green-400 text-2xl font-bold">#{team.seed}</p>
                        <p className="text-white/60 text-sm">Seed</p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-white/60 text-sm">{match.team1.name} vs {match.team2.name}</p>
                        </div>
                      </div>
                      <button
                        onClick={() => {
                  ...
                  <div className="p-6 border-t border-white/10">
                    <div className="flex gap-3">
                      <input
                        ...
                        className="flex-1 bg-[#0a0e1a]/50 border border-white/10 rounded-lg px-4 py-3 text-white placeholder-white/30 focus:outline-none focus:border-[#00d4ff]/50"
                      />
                      <button
              ...
              <div className="p-6 space-y-3">
                ...
                {[match.team1, match.team2].map(team => (
                  ...
                  >
                    ...
                    <Trophy className="w-5 h-5 text-yellow-400/0 group-hover:text-yellow-400 transition-colors" />
                  </button>
                ))}
              </div>
